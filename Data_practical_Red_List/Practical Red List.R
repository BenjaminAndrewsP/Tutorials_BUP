...
##Import csv files
landuse <- read.csv("Data_practical_Red_List/landuse/assessments.csv")
overexploitation <- read.csv("Data_practical_Red_List/overexploitation/assessments.csv")
invasion <- read.csv("Data_practical_Red_List/invasion/assessments.csv")
pollution <- read.csv("Data_practical_Red_List/pollution/assessments.csv")
climate <- read.csv("Data_practical_Red_List/climate/assessments.csv")
...
if(nrow(landuse)!=length(unique(landuse$scientificName))){
  landuse <- landuse[-which(duplicated(landuse$scientificName)),]
}

nrow(overexploitation)
length(unique(overexploitation$scientificName))
if(nrow(overexploitation)!=length(unique(overexploitation$scientificName))){
  overexploitation <- overexploitation[-which(duplicated(overexploitation$scientificName)),]
}

nrow(invasion)
length(unique(invasion$scientificName))
if(nrow(invasion)!=length(unique(invasion$scientificName))){
  invasion <- invasion[-which(duplicated(invasion$scientificName)),]
}

nrow(pollution)
length(unique(pollution$scientificName))
if(nrow(pollution)!=length(unique(pollution$scientificName))){
  pollution <- pollution[-which(duplicated(pollution$scientificName)),]
}

nrow(climate)
length(unique(climate$scientificName))
if(nrow(climate)!=length(unique(climate$scientificName))){
  climate <- climate[-which(duplicated(climate$scientificName)),]
}
...
ggVennDiagram(x, label_alpha = 0, set_color=c("red","blue","green","purple","orange"))
...
ggVennDiagram(y, label_alpha = 0, set_color=c("red","blue","green","purple","orange"))
# set.seed(20190708)
...
#######################
##Per taxonomic group##
landuse.tax <- read.csv("Data_practical_Red_List/landuse/taxonomy.csv")
overexploitation.tax <- read.csv("Data_practical_Red_List/overexploitation/taxonomy.csv")
invasion.tax <- read.csv("Data_practical_Red_List/invasion/taxonomy.csv")
pollution.tax <- read.csv("Data_practical_Red_List/pollution/taxonomy.csv")
climate.tax <- read.csv("Data_practical_Red_List/climate/taxonomy.csv")
...
quartz()
par(mfrow=c(2,4))
plot(x=1996:2025,y=threats.time[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="All species",log="y")
lines(x=1996:2025,y=threats.time[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time[,5],type = "b",pch=19,col="gray40")
...
plot(x=1996:2025,y=threats.time.mammal[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="Mammals",log="y")
lines(x=1996:2025,y=threats.time.mammal[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time.mammal[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time.mammal[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time.mammal[,5],type = "b",pch=19,col="gray40")

plot(x=1996:2025,y=threats.time.birds[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="Birds",log="y")
lines(x=1996:2025,y=threats.time.birds[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time.birds[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time.birds[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time.birds[,5],type = "b",pch=19,col="gray40")

plot(x=1996:2025,y=threats.time.fish[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="Fish",log="y")
lines(x=1996:2025,y=threats.time.fish[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time.fish[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time.fish[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time.fish[,5],type = "b",pch=19,col="gray40")

plot(x=1996:2025,y=threats.time.amphibian[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="Amphibians",log="y")
lines(x=1996:2025,y=threats.time.amphibian[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time.amphibian[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time.amphibian[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time.amphibian[,5],type = "b",pch=19,col="gray40")

plot(x=1996:2025,y=threats.time.gastropode[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="Gastropodes",log="y")
lines(x=1996:2025,y=threats.time.gastropode[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time.gastropode[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time.gastropode[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time.gastropode[,5],type = "b",pch=19,col="gray40")

plot(x=1996:2025,y=threats.time.flower[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="Flowers",log="y")
lines(x=1996:2025,y=threats.time.flower[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time.flower[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time.flower[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time.flower[,5],type = "b",pch=19,col="gray40")

plot(x=1996:2025,y=threats.time.reptile[,1],type = "b",pch=15,ylim=c(1,max(threats.time)),xlab="Year",ylab="Number of species",main="Reptiles",log="y")
lines(x=1996:2025,y=threats.time.reptile[,2],type = "b",pch=16,col="gray10")
lines(x=1996:2025,y=threats.time.reptile[,3],type = "b",pch=17,col="gray20")
lines(x=1996:2025,y=threats.time.reptile[,4],type = "b",pch=18,col="gray30")
lines(x=1996:2025,y=threats.time.reptile[,5],type = "b",pch=19,col="gray40")
